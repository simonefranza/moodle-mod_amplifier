...
$string['amplifier_password_invalid_feedback'] = 'Your password does not fulfill the above rules. Please read the instructions for creating a password carefully.';
$string['amplifier_password_not_equal_feedback'] = 'The passwords do not match.';
$string['amplifier_password_min_chars_feedback'] = 'The password must be 8 or more characters long. Please read the instructions for creating a password carefully.';
$string['amplifier_email_invalid_feedback'] = 'Please enter a valid E-Mail address.';
$string['amplifier_email_not_equal_feedback'] = 'The E-Mail adresses do not match.';
$string['amplifier_signup_modal_dialog_title'] = 'Creating user profile';
$string['amplifier_signup_form_title'] = utf8_encode('Registration data');
$string['amplifier_cancel'] = 'Cancel';
$string['amplifier_more_details'] = 'More details';

$string['amplifier'] = 'User Registration';

$string['amplifier_preferred_language'] = 'Language';
$string['amplifier_preferred_language_choose'] = 'Please choose a language to be used for DIGIVID';
...
$string['amplifier_user_role'] = 'User Role';
$string['amplifier_user_role_choose'] = 'Please choose your user role';
$string['amplifier_user_role_student'] = 'Student';
...
$string['amplifier_participation_info_terms_of_service_summary_1'] = 'The DIGIVID - DIGITAL COMPETENCES UNLEASHED: EDUCATION AND TRAINING OF DIGITAL COMPETENCES IN THE ERA OF COVID-19 platform (subsequent "DIGIVID") has been created by the DIGIVID project consortium, funded by the European Union\'s Erasmus Plus programme, grant agreement 2020-1-AT01-KA226-HE-092590.';
$string['amplifier_participation_info_terms_of_service_summary_2'] = 'DIGIVID is a learning platform for students, teachers (school & university), subsequently referred to as users.';
$string['amplifier_participation_info_terms_of_service_stmt_1'] = 'Data collected and processed: When using the platform following data are collected and used: user ID (automatically generated by the system), user name, email address, and role in the course (student, teacher (school), and teacher (university). After the summer school, all accounts will be deleted. The email is necessary in case you need to reset your password. If you do not want to share your email address, please contact the organizers of the workshop.';

$string['amplifier_account_setup'] = 'Account Setup';
$string['amplifier_account_setup_fill_in_credentials'] = 'Fill in your credentials';
$string['amplifier_account_setup_username'] = 'Username';
$string['amplifier_account_setup_username_rules'] = utf8_encode("Username rules: Allowed are lowercase letters, numbers, dash '-', underscore '_', period '.' and the at sign '@'");
$string['amplifier_account_setup_password'] = 'Password';
$string['amplifier_account_setup_password_repeat'] = 'Password (repeat)';
$string['amplifier_account_setup_password_rules'] = utf8_encode("Password rules: Minimum 8 characters, 1 number, 1 small letter, 1 capital letter, 1 special character. Allowed special characters: _ ~ - ! @ # $ % ^ & * '");
$string['amplifier_account_setup_email'] = 'Your email address';
$string['amplifier_account_setup_email_repeat'] = 'E-Mail address (repeat)';
$string['amplifier_account_setup_email_hint'] = 'If you do not want to share your email address, please contact the organizers of the workshop.';
...
$string["amplifier_reminder_frequency_monthly"] = "Monthly";
$string["amplifier_reminder_settings_startdate_label"] = "Start Date";
$string["amplifier_reminder_settings_enddate_label"] = "End Date";
$string["amplifier_reminder_settings_time_label"] = "Daytime";
$string["amplifier_reminder_settings_month1_label"] = "January";
$string["amplifier_reminder_settings_month2_label"] = "February";
$string["amplifier_reminder_settings_month3_label"] = "March";
$string["amplifier_reminder_settings_month4_label"] = "April";
$string["amplifier_reminder_settings_month5_label"] = "May";
$string["amplifier_reminder_settings_month6_label"] = "June";
$string["amplifier_reminder_settings_month7_label"] = "July";
$string["amplifier_reminder_settings_month8_label"] = "August";
$string["amplifier_reminder_settings_month9_label"] = "September";
...
$string['amplifier_placeholder_thoughts'] = 'My thoughts...';

$string['amplifier_user_reminder_message_subject'] = 'Training Amplifier - Learning Goal Reflection';

$string['amplifier_user_reminder_message_text'] = '
...
$string['amplifier_user_reminder_message_html'] = '
...
$string['privacy:metadata:amplifier_reflection'] = 'Information about a single reflection from a user about a specific learning goal.';
$string['privacy:metadata:amplifier_reflection:course'] = 'The ID of the course.';
...
$string['privacy:metadata:amplifier_reminder'] = 'Information about a reminder setting from a user for a specific learning goal.';
$string['privacy:metadata:amplifier_reminder:course'] = 'The ID of the course.';
...
$string['privacy:metadata:amplifier_setup_goals:course'] = 'The ID of the course.';
...
$string['privacy:metadata:amplifier_setup_reflection:course'] = 'The ID of the course.';
...
$string['privacy:metadata:amplifier_setup'] = 'Information about a user and the amplifier setup. If the finished flag is set true the user submitted the setup';
$string['privacy:metadata:amplifier_setup:course'] = 'The ID of the course.';
