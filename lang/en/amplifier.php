...
$string['amplifier_signup_form_title'] = 'Registration data';
...
$string['amplifier_account_setup_username_rules'] = "Username rules: Allowed are lowercase letters, numbers, dash '-', underscore '_', period '.' and the at sign '@'";
$string['amplifier_account_setup_password'] = 'Password';
$string['amplifier_account_setup_password_repeat'] = 'Password (repeat)';
$string['amplifier_account_setup_password_rules'] = "Password rules: Minimum 8 characters, 1 number, 1 small letter, 1 capital letter, 1 special character. Allowed special characters: _ ~ - ! @ # $ % ^ & * '";
